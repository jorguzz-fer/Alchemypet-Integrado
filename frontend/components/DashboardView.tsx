...
import { infoModulo } from '@/lib/modulos';
...
// Visão geral. Sem `modulo`, mostra todas as pendências (particular + convênio)
// com seletor de tipo nos filtros.
export default function DashboardView({ modulo }: { modulo?: Modulo }) {
  ...
  const carregar = useCallback(
    async (f: FiltrosPendencias, signal?: AbortSignal) => {
      ...
      setErro(null);
      try {
        const d = await api.dashboard({ ...f, modulo: modulo ?? f.modulo }, signal);
        setDados(d);
      } catch (e) {
    ...
    <div className="page">
      <div className="page-head">
        <div>
          <h1>Visão geral</h1>
          <div className="lead">
            Indicadores das {descricao} no período selecionado.
          </div>
        </div>
      </div>
        ...
        <>
          ...
          <div className="grid-charts">
            ...
            <div className="card">
              ...
              {!modulo ? (
                <>
                  <h4 style={{ marginTop: 18 }}>Por tipo</h4>
                  <div className="csub">Particular × Convênio.</div>
                  <ListaBarras itens={dados.por_modulo} alt />
                </>
              ) : null}
            </div>
          </div>
          ...
          <div className="grid-charts-2">
            ...
            <div className="card">
              <h4>Motivos</h4>
              <div className="csub">Motivos mais frequentes das pendências.</div>
